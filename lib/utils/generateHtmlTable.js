    ...
    <main class="row title">
      <ul>
        ...
        <li style="width: 100%; text-align: center;" class="font-small-2">
          ...
          <a class="zero" href="https://t.me/italofialho" target="_blank">https://t.me/italofialho</a>
        </li>
      </ul>
    </main>
`
...
`
  ...
  const disclaimer = `
    <main class="row title">
      <ul>
        <li style="width: 100%; text-align: center;" class="font-small-2">
          Os detalhes do ativo <b>${composition.ticker}</b> são atualizados seguindo as informações página do <b>Comparador de Fundos</b> da própria Monetus.
        </li>
        <li style="width: 100%; text-align: center;" class="font-small-2">
          Bot não oficial para exibir a rentabilidade do Monetus FIA. Criador
          <a class="zero" href="https://t.me/italofialho" target="_blank">https://t.me/italofialho</a>
...
`
  ...
  const disclaimer = `
    <main class="row title">
      <ul>
        <li style="width: 100%; text-align: center;" class="font-small-2">
          A cotação do ativo <b>${asset.ticker}</b> são atualizados seguindo as informações página do <b>Comparador de Fundos</b> da própria Monetus.
        </li>
        <li style="width: 100%; text-align: center;" class="font-small-2">
          Bot não oficial para exibir a rentabilidade do Monetus FIA. Criador
          <a class="zero" href="https://t.me/italofialho" target="_blank">https://t.me/italofialho</a>
