...
bot.init = (ctx) => {
  return new Promise((resolve) => {
    ...
    if (process.env.ENV !== 'dev') {
      ...
      if (isHoliday) {
        message += ` Hoje é feriado (${utils.currentHoliday(now.format('DD/MM'))}) por isso o mercado não está aberto e eu vou desativar as notificações diarias e de hora em hora!`
      }
